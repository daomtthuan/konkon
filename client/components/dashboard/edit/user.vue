<template>
  <b-modal id="edit-user" @show="show" title="Edit" ok-title="Close" ok-variant="secondary" ok-only centered hide-header-close>
    <b-form>
      <b-form-group label="Account:" label-for="form-account-information-input-account">
        <b-input-group>
          <b-form-input id="form-account-information-input-account" v-model="this.$store.state.dashboard.edit.item.account" readonly />
      ...
      <b-form-group label="Email:" label-for="form-account-information-input-email">
        <b-form-input id="form-account-information-input-email" v-model="user.email" autocomplete="email" :state="valid.email.state" />
      ...
      <b-form-group label="Fullname:" label-for="form-account-information-input-name">
        <b-form-input id="form-account-information-input-name" v-model="user.name" autocomplete="name" :state="valid.name.state" />
      ...
      <b-form-group label="Birthday:" label-for="form-account-information-input-birthday">
        <b-form-input type="date" id="form-account-information-input-birthday" v-model="user.birthday" autocomplete="bday" />
      ...
      <b-form-group label="Phone number:" label-for="form-account-information-input-phone">
        <b-form-input type="tel" id="form-account-information-input-phone" v-model="user.phone" autocomplete="tel" :state="valid.phone.state" />
      ...
      <b-form-group label="Address:" label-for="form-account-information-input-address">
        <b-form-input id="form-account-information-input-address" v-model="user.address" :state="valid.address.state" />
